(function() {
    ...
    // ==================== DATA ====================
    const SONGS = [
        { name: "Lintasan Tak Bermakna", group: "Fragmen Suara", url: "https://files.catbox.moe/7p3gmt.opus", cover: "https://i.postimg.cc/W3pHjGCQ/fragmen.webp" },
        { name: "Padahal Sudah Bilang", group: "Fragmen Suara", url: "https://files.catbox.moe/izfodb.opus", cover: "https://i.postimg.cc/W3pHjGCQ/fragmen.webp" },
        { name: "Mimpi yang Tertunda", group: "Fragmen Suara", url: "https://files.catbox.moe/44mglv.opus", cover: "https://i.postimg.cc/W3pHjGCQ/fragmen.webp" },
        { name: "Langit Masih Sama", group: "Fragmen Suara", url: "https://files.catbox.moe/m1gzfk.opus", cover: "https://i.postimg.cc/W3pHjGCQ/fragmen.webp" },
        { name: "Suatu Hari Nanti", group: "Fragmen Suara", url: "https://files.catbox.moe/j26sgp.opus", cover: "https://i.postimg.cc/W3pHjGCQ/fragmen.webp" },
        { name: "Nada Terpendam", group: "Resonansi Dalam Diam", url: "https://files.catbox.moe/suwzc2.opus", cover: "https://i.postimg.cc/Tw24GVFB/resonansi.webp" },
        { name: "Langit Patah Arah", group: "Resonansi Dalam Diam", url: "https://files.catbox.moe/wl8kn9.opus", cover: "https://i.postimg.cc/Tw24GVFB/resonansi.webp" },
        { name: "Tak Bernama, Tapi Ada", group: "Resonansi Dalam Diam", url: "https://files.catbox.moe/vh4bn7.opus", cover: "https://i.postimg.cc/Tw24GVFB/resonansi.webp" },
        { name: "Resonansi Dalam Diam", group: "Resonansi Dalam Diam", url: "https://files.catbox.moe/8l1bkc.opus", cover: "https://i.postimg.cc/Tw24GVFB/resonansi.webp" },
        { name: "Runtuh Tanpa Suara", group: "Resonansi Dalam Diam", url: "https://files.catbox.moe/52dcsz.opus", cover: "https://i.postimg.cc/Tw24GVFB/resonansi.webp" },
        { name: "Kilau Tanpa Sorotan", group: "Resonansi Dalam Diam", url: "https://files.catbox.moe/m28u99.opus", cover: "https://i.postimg.cc/Tw24GVFB/resonansi.webp" },
        { name: "Gelombang Terakhir", group: "Resonansi Dalam Diam", url: "https://files.catbox.moe/6lkkg2.opus", cover: "https://i.postimg.cc/Tw24GVFB/resonansi.webp" },
        { name: "Saya Akan Lawan", group: "Saya Akan Lawan", url: "https://files.catbox.moe/704z9d.opus", cover: "https://i.postimg.cc/Ghj99yqK/sayaakanlawan(Copy).png" }
    ];
    ...
    function init() {
        ...
        $('btnMoreToggle')?.addEventListener('click', () => {
            $('mainArea')?.classList.toggle('more-collapsed');
        });
